...
?>
  <h2>Widget</h2>
  Go to widget menu and drag and drop the "Send link to Friend" widget to your sidebar location.
  ...
  <h2>Short code for pages/posts</h2>
  <div style="padding-top:7px;padding-bottom:7px;"> <code style="padding:7px;"> [SEND-LINK-TO-FRIEND=LOAD] </code></div>
  <h2>About plugin!</h2>
  Plug-in created by <a target="_blank" href='http://www.gopiplus.com/work/2010/07/18/send-link-to-friend/'>www.gopiplus.com</a><br>
