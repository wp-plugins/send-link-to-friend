...
?>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
<input name="Help" lang="publish" class="button-primary" onclick="window.open('http://www.gopipulse.com/work/2010/07/18/send-link-to-friend/');" value="Help" type="button" />
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
<?php
echo '</form>';
echo '</td>';
...
Check official website for more information <a target="_blank" href='http://www.gopipulse.com/work/2010/07/18/send-link-to-friend/'>click here</a>
</div>
